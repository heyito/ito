...
class HomeWindow(QMainWindow):
    def __init__(self):
        ...
        self.asr_source = SegmentedButtonGroup(["openai_api", "faster_whisper"])
        ...
        self.asr_model = SegmentedButtonGroup(["whisper-1"])
        asr_model_label = QLabel("Model")
        asr_model_label.setStyleSheet("font-size: 13px; color: #FFFFFF; padding: 8px 0px;")
        asr_model_container = QWidget()
        asr_model_layout = QVBoxLayout(asr_model_container)
        asr_model_layout.setContentsMargins(0, 0, 0, 0)
        asr_model_layout.setSpacing(4)
        asr_model_layout.addWidget(asr_model_label)
        asr_model_layout.addWidget(self.asr_model)
        form_layout.addRow(asr_model_container)

        self.asr_local_model_size = SegmentedButtonGroup([
            "tiny", "tiny.en", "base", "base.en", "small", "small.en", 
            "medium", "medium.en", "large-v1", "large-v2", "large-v3"
        ])
        asr_local_model_size_label = QLabel("Local Model Size")
        asr_local_model_size_label.setStyleSheet("font-size: 13px; color: #FFFFFF; padding: 8px 0px;")
        asr_local_model_size_container = QWidget()
        asr_local_model_size_layout = QVBoxLayout(asr_local_model_size_container)
        asr_local_model_size_layout.setContentsMargins(0, 0, 0, 0)
        asr_local_model_size_layout.setSpacing(4)
        asr_local_model_size_layout.addWidget(asr_local_model_size_label)
        asr_local_model_size_layout.addWidget(self.asr_local_model_size)
        form_layout.addRow(asr_local_model_size_container)

        self.asr_device = SegmentedButtonGroup(["auto"])
        asr_device_label = QLabel("Device")
        asr_device_label.setStyleSheet("font-size: 13px; color: #FFFFFF; padding: 8px 0px;")
        ...
        asr_device_layout.addWidget(asr_device_label)
        asr_device_layout.addWidget(self.asr_device)
        form_layout.addRow(asr_device_container)

        self.asr_compute_type = SegmentedButtonGroup(["default"])
        asr_compute_type_label = QLabel("Compute Type")
        asr_compute_type_label.setStyleSheet("font-size: 13px; color: #FFFFFF; padding: 8px 0px;")
        ...
        asr_compute_type_layout.addWidget(asr_compute_type_label)
        ...
        self.llm_source = SegmentedButtonGroup(["ollama", "openai_api"])
