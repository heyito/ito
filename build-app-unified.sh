...
create_windows_installer() {
    ...
    # Check if we're on macOS/Linux and use Docker for Windows builds
    if [[ "$OSTYPE" == "darwin"* ]] || [[ "$OSTYPE" == "linux-gnu"* ]]; then
        ...
        print_info "Building Windows installer natively..."
...
main() {
    ...
    case $PLATFORM in
        ...
        "all")
            ...
            create_windows_installer
            echo
            print_status "Multi-platform build process completed successfully! 🎉"
            print_info "All installers are ready in the dist/ directory"
            ;;
    esac
}
