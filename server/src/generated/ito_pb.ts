...
export const file_ito: GenFile = /*@__PURE__*/
  fileDesc("", [file_buf_validate_validate]);
...
export type TimingReport = Message<"ito.TimingReport"> & {
  ...
  /**
   * @generated from field: repeated ito.TimingEvent events = 5;
   */
  events: TimingEvent[];

  /**
   * @generated from field: int64 total_duration_ms = 6;
   */
...
/**
 * @generated from message ito.SubmitTimingDataRequest
 */
export type SubmitTimingDataRequest = Message<"ito.SubmitTimingDataRequest"> & {
  /**
...
/**
 * Describes the message ito.SubmitTimingDataRequest.
 * Use `create(SubmitTimingDataRequestSchema)` to create a new message.
 */
export const SubmitTimingDataRequestSchema: GenMessage<SubmitTimingDataRequest> = /*@__PURE__*/
  messageDesc(file_ito, 31);

/**
 * @generated from message ito.SubmitTimingDataResponse
 */
export type SubmitTimingDataResponse = Message<"ito.SubmitTimingDataResponse"> & {
  /**
  ...
  /**
   * @generated from field: int32 accepted_count = 2;
   */
  acceptedCount: number;
};

/**
 * Describes the message ito.SubmitTimingDataResponse.
 * Use `create(SubmitTimingDataResponseSchema)` to create a new message.
 */
export const SubmitTimingDataResponseSchema: GenMessage<SubmitTimingDataResponse> = /*@__PURE__*/
...
export const ItoService: GenService<{
  ...
  submitTimingData: {
    methodKind: "unary";
    input: typeof SubmitTimingDataRequestSchema;
    output: typeof SubmitTimingDataResponseSchema;
  },
}> = /*@__PURE__*/
