 ...
 */
function createWavHeader(dataLength: number, sampleRate: number, channelCount: number, bitDepth: number): Buffer {
  ...
  router.service(ItoServiceDesc, {
    ...
    async transcribeStream(
      ...
      try {
        ...
        const wavHeader = createWavHeader(fullAudio.length, sampleRate, channels, bitDepth);
