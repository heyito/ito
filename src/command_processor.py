...
class CommandProcessor:
    ...
    def __init__(self, processing_engine: ProcessingEngine, status_queue: Optional[queue.Queue]):
    ...
    def is_processing(self) -> bool:
        ...
        with self._lock:
            ...
            if self._is_processing and (not self._processing_thread or not self._processing_thread.is_alive()):
                 print("Warning: is_processing=True but thread is dead. Resetting state.")
    ...
    def _processing_thread_target(self,
        ...
        try:
            ...
            final_status = "Processing successful" if success else f"Error processing: {error_msg}"
