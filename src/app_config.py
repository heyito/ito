...
class AppConfig:
    ...
    def __init__(self, config_dict: dict[str, Any]):
        ...
        self.openai_user_command_model: str = openai_section.get('user_command_model', 'gpt-4.1')
        ...
        self.groq_user_command_model: str = groq_section.get('user_command_model', 'llama3-8b-8192')
        ...
        self.openai_asr_model_config: str = config_dict.get('OpenAI', {}).get('asr_model', 'whisper-1')
        self.groq_asr_model_config: str = config_dict.get('Groq', {}).get('asr_model', 'distil-whisper-large-v3-en') 
        ...
        if self.asr_source == 'openai_api':
            ...
            self.asr_model: str = self.asr_local_model_size # For faster_whisper, this is the effective model identifier
        else: # Default if source is unknown or not handled above
            self.asr_model: str = asr_section.get('model', 'whisper-1') # Default to a generic whisper model
